...
-- https://supabase.com/dashboard/project/vbajxsvagxksytcdbzyj/sql/new
...
create policy "Service role full access resumes" on public.resumes for all using (true);
...
create policy "Service role full access applications" on public.applications for all using (true);
